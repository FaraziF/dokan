...
Scenario('Preview and Explore Vendor Dashboard', ({ I }) => {
        ...
        I.click('Coupons');
            ...
            I.checkError();
            I.click('//*[@id="post-5"]/div/div/div[2]/article/table/tbody/tr/td[1]/div[1]/strong/a/span');
            I.checkError();
        I.click('Reports');
        ...
        I.click('Return Request');
            I.waitForElement('.dokan-rma-request-area');
                I.checkError();
            I.click('//*[@id="post-5"]/div/div/div[2]/article/table/tbody/tr/td[6]/a');
                I.checkError();
        I.click('Staff');
            I.waitForElement('.dokan-staffs-area');
            I.checkError();
            I.click('//*[@id="post-5"]/div/div/div[2]/article/table/tbody/tr/td[1]/a');
            I.checkError();
		...
		I.click('.support');
            ...
            I.checkError();
                I.click('//*[@id="post-5"]/div/div/div[2]/div/table/tbody/tr/td[1]/a');
                I.checkError();
