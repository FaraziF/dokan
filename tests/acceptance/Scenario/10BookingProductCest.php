...
class BookingProductCest
{
    ...
    // tests
    public function vendorAddBookingProduct(\Step\Acceptance\MultiSteps $I)
    {
    	 $I->loginAsVendor();
    	 $I->click('Booking');
    	 $I->wait(3);
    ...
    public function Customercartproduct(\Step\Acceptance\MultiSteps $I)
    {
    	$I->loginAsCustomer();
        $I->amOnPage('/shop/');
